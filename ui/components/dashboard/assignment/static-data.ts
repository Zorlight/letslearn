export const fileTypeColor: Record<string, string> = {
  pdf: "#ef4444",
  docx: "#3b82f6",
  xlsx: "#22c55e",
  pptx: "#f59e0b",
...
export const sampleFileTypeSubmisisonData = [
...
export const sampleGradedSubmissionData = [
...
export const sampleAvgCompletionRateData = [
